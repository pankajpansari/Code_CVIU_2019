...
//    std::cout << "Inference done" << std::endl;
 //   std::cout << "Q rows  = " << Q.rows() << " Q rows  = " << Q.cols() << std::endl;
  ...
  //  std::cout << "Energy computed" << std::endl;
   ...
   // std::cout << "Discretized energy computed" << std::endl;
...
//    std::cout << "Final energy = " << discretized_energy << std::endl;
    txt_file.close();
}
...
//    float bil_potts = 1.699011;
    ...
    logFile << "imskip = " << imskip << "       bins = 500      step = 2/(k + 2)" << std::endl;
