function [overall_acc] = msrc_test(path, dataset_split)
% path -> path where the segmentation results are kept

fprintf('path = %s\n', path)
dpath = '/home/pankaj/SubmodularInference/data/input/';
...
%gtimgpath= [datadir 'GroundTruth/%s_GT.bmp'];
%gtimgpath= [datadir 'GroundTruth/%s_GT.bmp'];
