...
int main(int argc, char *argv[]){
    ...
    assert(argc == 7 && "example usage: ./inference_sparse_synthetic unary_0.txt synthetic_tree_20_1.txt 1 100 20 /home/pankaj/SubmodularInference/data/working/03_10_2017");
    ...
    std::string log_file = log_dir + "/submodular_log_w_" + std::to_string(float(weight)) + "_" + arg1 + "_" + arg2;
    std::cout << "Log file = " << log_file << std::endl;
    crf.submodularFrankWolfe_tree(unary, H, log_file, G);
